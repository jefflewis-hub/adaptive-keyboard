...
struct IntroView: View {
    ...
    private var descriptionText: String {
        ...
        case .split:
            return "A redesigned keyboard: no keys in the middle, two taller clusters on the sides. Same sentences as Full Keyboard, just typed on this new shape — this is the real before/after comparison."
        }
    }
}
